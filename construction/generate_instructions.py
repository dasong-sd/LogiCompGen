...
from construction.instruction_translator import (
    MultiAgent,
...
def main(
    ...
    config_file: Annotated[Path, typer.Option()] = Path("config/teladoc_generation.yaml"),
    trace_file: Annotated[Path, typer.Option()] = Path("data/ground_truth/teladoc_ground_truth_cases.json"),
    output_dir: Annotated[Path, typer.Option()] = Path("results/construction_runs/instruction_candidates"),
