...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="results/construction_runs/reference_traces", help="Directory to save newly generated test cases.")
    ...
    if args.scenario == "bank_manager":
        rules_file = "data/ltl/psd2/7_label_ltl_rules.json"
    elif args.scenario == "smart_lock":
        rules_file = "data/ltl/esti/7_label_ltl_rules.json"
    elif args.scenario == "teladoc":
        rules_file = "data/ltl/hipaa/7_label_ltl_rules.json"
    else:
